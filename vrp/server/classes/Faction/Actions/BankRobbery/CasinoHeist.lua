...
function CasinoHeist:startAlarm()
	PlayerManager:getSingleton():breakingNews("A currently unknown faction raids Caligula's Casino!")
	Discord:getSingleton():outputBreakingNews("A currently unknown faction raids Caligula's Casino!")
	FactionState:getSingleton():sendWarning("Caligula's Casino is raided!", "New Alert", true, {2193.39, 1677.15, 12.37})
