...
function BankLosSantos:startRob(player)
	...
	PlayerManager:getSingleton():breakingNews("A currently unknown faction raids the Los Santos Bank!")
	Discord:getSingleton():outputBreakingNews("A currently unknown faction raids the Los Santos Bank!")
	FactionState:getSingleton():sendWarning("The bank in Los Santos is being robbed!", "New Alert", true, {1457.67, -996.27, 26.83})
