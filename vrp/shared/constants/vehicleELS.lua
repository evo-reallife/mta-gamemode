ELS_PRESET = {
    ...
    ["Police_Burrito"] = { --Normal Van (SAPD)
        hasSiren = true,
        headlightSequence = true,
		lightBar = {0, 0.7, 0.95},
        sequenceCount = 2,
    ...
    ["Police_Burrito_Orange"] = { --Orange Van 2 (SASF)
        hasSiren = true,
        headlightSequence = true,
        lightBar = {0, 0.7, 0.95, 1.05, "orange"},
        -- lightBar = {0, 0.7, 0.95, "orange"},
        sequenceCount = 2,
        sequenceDuration = 300,
        light = {
            r1 = {-0.75, 0.7, 1, 0.3, 255, 150, 0},
            r2 = {-0.5, 0.7, 1, 0.3, 255, 150, 0},
            r3 = {-0.25, 0.7, 1, 0.3, 255, 150, 0},
            b1 = {0.75, 0.7, 1, 0.3, 255, 150, 0},
            b2 = {0.5, 0.7, 1, 0.3, 255, 150, 0},
            b3 = {0.25, 0.7, 1, 0.3, 255, 150, 0},
        },
        sequence = {
            [1] = {
                r1 = {fade = {0}},
    ...
    ["Police_Burrito_FBI"] = { --Orange Van 2 (SASF)
        hasSiren = true,
        ...
        --name = {x, y, z, size, r, g, b, [a]}
        light = {
            -- Front OF the Car Flash

            f1 = {0.75, 2.6, -0.19, 0.25, 255, 255, 255, 0}, -- front flash
            f2 = {-0.75, 2.6, -0.19, 0.25, 255, 255, 255, 0}, --  front flash

            -- Switches
            
            sb = {-0.15, 0.5, 0.7, 0.25, 0, 50, 255, 0}, --side blue
            sr = {0.15, 0.5, 0.7, 0.25, 200,10, 0, 0}, -- side red

            br = {-0.5, -1.8, 0.2, 0.15, 200, 10, 0, 0}, -- side red
            bb = {0.5, -1.8, 0.2, 0.15, 0, 50, 255, 0}, -- side blue
        },
        sequence = {
            [1] = {
                sr = {color={0,50,255,255}},
