...
-- *
-- ****************************************************************************
GUIPaydayBox = inherit(DxRectangle)
...
function GUIPaydayBox:createUI()
	...
	GUILabel:new(self.m_W/3, self.m_HeaderHeight/3, self.m_W/3, self.m_HeaderHeight/1.5, _"Payday", self):setAlignX("center")
	GUILabel:new(0, self.m_HeaderHeight*0.1, self.m_W - self.m_HeaderHeight*0.1, self.m_HeaderHeight/3, _"Spacebar to hide", self):setAlignX("right"):setColor(Color.LightGrey)
	GUILabel:new(self.m_HeaderHeight*0.1, self.m_HeaderHeight/1.5, self.m_W, self.m_HeaderHeight/2, _"Income", self):setAlignX("left")
	GUILabel:new(0, self.m_HeaderHeight/1.5, self.m_W - self.m_HeaderHeight*0.1, self.m_HeaderHeight/2, _"Expenses", self):setAlignX("right")
	local i_inc = 0
	local i_out = 0
	...
	if self.m_PaydayTexts["info"] then
		DxRectangle:new(margin, self.m_BaseHeight, self.m_W - margin*2, 2, Color.Accent, self):setDrawingEnabled(true)
		self.m_BaseHeight = self.m_BaseHeight + 4
		GUILabel:new(margin, self.m_BaseHeight, self.m_W, self.m_HeaderHeight/2, _"Further information", self):setAlignX("left")
		self.m_BaseHeight = self.m_BaseHeight + self.m_HeaderHeight/2
