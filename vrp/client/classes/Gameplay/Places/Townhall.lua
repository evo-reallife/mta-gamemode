...
function Townhall:constructor()
	...
	groupInfoPed.Name = _"Private firms and gangs"
	groupInfoPed.Description = _"Click me for more information!"
	groupInfoPed.Type = 3
	...
	groupImmoPed.Name = _"Firms/Gang properties"
	groupImmoPed:setInterior(5)
	groupImmoPed.Description = _"Click me for more information!"
	groupImmoPed.Type = 5
	groupImmoPed.Func = function()
		if localPlayer:getGroupName() ~= "" then
			GroupPropertyBuy:new()
		else ErrorBox:new(_"You don't have a Firm/gang!")
		end
	end
	...
	housesForSalePed.Name = _"Houses"
	housesForSalePed:setInterior(5)
	housesForSalePed.Description = _"Click me for more information!"
	...
	itemInfoPed.Name = _"Identification / purchase contract"
	itemInfoPed:setInterior(5)
	itemInfoPed.Description = _"Click me for more information!"
	itemInfoPed.Type = 4
	...
	unregisterVehiclePed.Name = _"Registering/de-registering vehicles"
	unregisterVehiclePed:setInterior(5)
	unregisterVehiclePed.Description = _"Click me for more information!"
	...
	itemSpawnerPed.Name = _"Vehicle rental"
	itemSpawnerPed.Description = _("Rent a vehicle for %s$!", VEHICLE_RENTAL_PRICE)
	...
	itemSpawnerPed2.Name = _"Vehicle rental"
	itemSpawnerPed2.Description = _("Rent a vehicle for %s$!", VEHICLE_RENTAL_PRICE)
	...
	itemSpawnerPed3.Name = _"Equipment vehicle"
	itemSpawnerPed3.Description = _"This is where the weapon truck starts!"
	...
	itemSpawnerPed4.Name = _"Illegal weapons truck"
	itemSpawnerPed4.Description = _"This is where the weapon truck starts!"
	...
	itemSpawnerPed5.Name = _"Vehicle rental"
	itemSpawnerPed5.Description = _("Rent a vehicle for %s$!", VEHICLE_RENTAL_PRICE)
	...
	itemSpawnerPed6.Name = _"First aid"
	itemSpawnerPed6.Description = _"Click me for healing!"
	...
	itemSpawnerPed7.Name = _"Job list"
	itemSpawnerPed7:setInterior(5)
	itemSpawnerPed7.Description = _"Click here for more information!"
