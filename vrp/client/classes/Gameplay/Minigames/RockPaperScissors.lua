...
function RockPaperScissorsResult:constructor(result, pTable)
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Scissors Rock Paper - Result", true, true, self)
...
function RockPaperScissorsResult:showResult(result, pTable)
	GUILabel:new(30, 30, 100, 30, _"You:", self.m_Window):setAlignX("center")
