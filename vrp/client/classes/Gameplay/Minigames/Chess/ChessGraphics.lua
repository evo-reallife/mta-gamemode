...
function ChessGraphics:drawPawnSelection()
	if self.m_DrawPawnSelection then
		...
		dxDrawText("Swap the piece! (Autom. Queen)", centerX-imageWidth*1.1, centerY-imageWidth*0.7+1, centerX*2, centerY-imageWidth*0.6+1, tocolor(0, 0, 0, 255), 1, "default-bold", "left", "top")
		dxDrawText("Swap the piece! (Autom. Queen)", centerX-imageWidth*1.1, centerY-imageWidth*0.7, centerX*2, centerY-imageWidth*0.6, tocolor(255, 255, 255, 255), 1, "default-bold", "left", "top")
