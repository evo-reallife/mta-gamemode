...
function Fishing.load()
	...
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Fisherman Lutz", "Sell me your catch!")
	setElementData(ped, "clickable", true)

	ped:setData("onClickEvent",
		function()
			FishingPedGUI:new("Fisherman Lutz")
		end
	)
	...
	ped:setData("NPC:Immortal", true)
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Fisherman Heinz", "Sell me your catch!", 0, 1.3)
	setElementData(ped, "clickable", true)

	ped:setData("onClickEvent",
		function()
			FishingPedGUI:new("Fisherman Heinz")
		end
	)
	--Tierra Robada
	...
	ped:setData("NPC:Immortal", true)
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Fisherman Bernd", "Sell me your catch!", 0, 1.3)
	setElementData(ped, "clickable", true)

	ped:setData("onClickEvent",
		function()
			FishingPedGUI:new("Fisherman Bernd")
		end
	)
	--Angler Insel
	...
	ped:setData("NPC:Immortal", true)
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Fisherman Dennis", "Sell me your catch!", 0, 1.3)
	setElementData(ped, "clickable", true)

	ped:setData("onClickEvent",
		function()
			FishingPedGUI:new("Fisherman Dennis")
		end
	)
end
