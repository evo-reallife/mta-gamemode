...
function MapEditorMapSettingsGUI:constructor(id, mapInfos)
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Map Editor: Map Settings", true, true, self)
	
	self.m_NameLabel = GUIGridLabel:new(1, 1, 4, 1, "Name:", self.m_Window)
	self.m_ActiveLabel = GUIGridLabel:new(1, 2, 4, 1, "Active:", self.m_Window)
	self.m_SaveObjectsLabel = GUIGridLabel:new(1, 3, 4, 1, "Saves objects:", self.m_Window)
    self.m_DeactivatableLabel = GUIGridLabel:new(1, 4, 4, 1, "(De) Activatable:", self.m_Window)
	...
	self.m_SaveButton = GUIGridButton:new(4, 5, 4, 1, "Save", self.m_Window)
    self.m_DiscardButton = GUIGridButton:new(8, 5, 4, 1, "Cancel", self.m_Window)
