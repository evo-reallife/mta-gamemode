...
function MapEditorMainGUI:constructor()
    ...
    self.m_CreateObjectButton = GUIGridButton:new(1, 1, 3, 1, FontAwesomeSymbols.Plus, self.m_Window):setFont(FontAwesome(24)):setTooltip("Create Object", "top"):setBackgroundColor(Color.Green)
	self.m_DeleteWorldObjectButton = GUIGridButton:new(1, 2, 3, 1, FontAwesomeSymbols.Erase, self.m_Window):setFont(FontAwesome(24)):setTooltip("Remove World Object", "top"):setBackgroundColor(Color.Red)
    self.m_ChangeMapButton = GUIGridButton:new(4, 1, 3, 1, FontAwesomeSymbols.Edit, self.m_Window):setFont(FontAwesome(24)):setTooltip("Change Map", "top"):setBackgroundColor(Color.Orange)
    self.m_HelpButton = GUIGridButton:new(4, 2, 3, 1, FontAwesomeSymbols.Question, self.m_Window):setFont(FontAwesome(24)):setTooltip("Help", "top")
