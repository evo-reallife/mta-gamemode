...
function MapEditorEditingPlayersGUI:constructor()
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Map Editor: Editing Players", true, true, self)
    ...
    self.m_EndButton = GUIGridButton:new(1, 11, 9, 1, "Close Map Editor", self.m_Window)
