...
function ShortMessageQuestion:constructor(text, yesCallback, noCallback, color)
	self.m_Question = ShortMessage:new(("%s \n(Left-click Yes, right-click No)"):format(text), "Frage", color, -1)
