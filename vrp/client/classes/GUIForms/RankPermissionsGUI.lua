...
function RankPermissionsGUI:constructor(permissionsType, type)
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Manage permissions", true, true, self)
	
	self.m_PermissionsList = GUIGridGridList:new(1, 1, 9, 11, self.m_Window)
	self.m_PermissionsList:addColumn(_"Permission", 1)
	
	self.m_SaveButton = GUIGridButton:new(1, 12, 11, 1, _"Save", self.m_Window)
