...
function SendMoneyGUI:constructor(func, moneyAmount)
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Send money", true, true, self)
	GUILabel:new(self.m_Width*0.03, self.m_Height*0.31, self.m_Width*0.3, self.m_Height*0.25, _"Amount:", self.m_Window)
	...
	self.m_SendMoneyButton = GUIButton:new(self.m_Width*0.15, self.m_Height*0.64, self.m_Width*0.7, self.m_Height*0.27, _"Send", self.m_Window):setBackgroundColor(Color.Yellow):setBarEnabled(true)
	...
	self.m_SendMoneyButton.onLeftClick = function()
		...
		if amount and amount > 0 then
			...
			ErrorBox:new(_"Please enter a valid number!")
		end
	end
end
