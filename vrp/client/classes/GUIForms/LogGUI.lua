...
function LogGUI:constructor(parent, url)
	...
	GUILabel:new(parent.m_Width*0.44, parent.m_Height*0.02+yOffset, parent.m_Width*0.2, parent.m_Height*0.08, _"Search:", parent)
	...
	self.m_LogGrid:addColumn("Time", 0.2)
	self.m_LogGrid:addColumn("Description", 0.8)
