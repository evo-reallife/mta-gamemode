...
function ItemDepotGUI:constructor(element)
    ...
    GUILabel:new(10, 35, 340, 35, _"Inventory:", self.m_Window)
    self.m_LoadingLabel = GUILabel:new(10, 70, 250, 250, _"is being loaded...", self.m_Window):setAlignX("center"):setAlignY("center"):setFontSize(1):setFont(VRPFont(20))
    ...
    self.m_AmountLabel = GUILabel:new(10, 325, 250, 30, _"Item-Quantity:", self.m_Window)
