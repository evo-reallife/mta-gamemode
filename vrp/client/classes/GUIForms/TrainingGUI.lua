...
function TrainingGUI:constructor( id )
	...
	self.m_ID = id
	GUILabel:new(self.m_Width*0.02, 35, self.m_Width*0.96, self.m_Height*0.05, "Warning: All your weapons will be deleted when you enter training!", self.m_Window):setColor(Color.Red)

	self.m_JoinButton = GUIButton:new(self.m_Width-self.m_Width*0.32, self.m_Height-self.m_Height*0.09, self.m_Width*0.3, self.m_Height*0.07, _"Enter", self.m_Window):setBackgroundColor(Color.Green):setBarEnabled(true)
