...
function AdventCalenderGUI:constructor()
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"EVo Advent calendar", true, true, self)
	self.m_Window:deleteOnClose(true)

	self.m_NameLabel = GUIGridLabel:new(1, 7, 24, 1, _("Today's door: %d. December", getRealTime().monthday), self.m_Window)
	self.m_Packages = GUIGridLabel:new(1, 8, 24, 1, _("Reward: 5 packets"), self.m_Window)

	self.m_StartQuest = GUIGridButton:new(21, 8, 4, 1, "Open door", self.m_Window)
