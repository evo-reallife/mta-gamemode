...
function Christmas:constructor()
	...
	if EVENT_CHRISTMAS_MARKET then
		...
		local wheelBubble = SpeakBubble3D:new(wheelDummy, "Christmas", "Wheel of fortune", 180, 1.5)
		...
		ped:setFrozen(true)
		ped.SpeakBubble = SpeakBubble3D:new(ped, "Christmas", "Ferris wheel", 0, 1.3)
	...
	ped:setData("NPC:Immortal", true)
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Christmas", "Rewards store", 0, 1.3)
	ped.SpeakBubble:setBorderColor(Color.LightRed)
	ped.SpeakBubble:setTextColor(Color.LightRed)
	setElementData(ped, "clickable", true)
	...
	if ped then
		ped:setData("NPC:Immortal", true)
		ped:setFrozen(true)
		ped.SpeakBubble = SpeakBubble3D:new(ped, "Christmas", "Advent calendar", 0, 1.3)
		ped.SpeakBubble:setBorderColor(Color.LightRed)
		ped.SpeakBubble:setTextColor(Color.LightRed)
		setElementData(ped, "clickable", true)
		...
		blip:attachTo(ped)
		blip:setDisplayText("Advent calendar")
	end
	...
	if ped then
		ped:setData("NPC:Immortal", true)
		ped:setFrozen(true)
		ped.SpeakBubble = SpeakBubble3D:new(ped, "Christmas", "Cookie Clicker", 0, 1.3)
		ped.SpeakBubble:setBorderColor(Color.LightRed)
		ped.SpeakBubble:setTextColor(Color.LightRed)
		setElementData(ped, "clickable", true)
	...
	ped:setData("NPC:Immortal", true)
	ped:setFrozen(true)
	ped.SpeakBubble = SpeakBubble3D:new(ped, "Christmas transport", "This is where the Christmas truck starts", 0, 1.4)
	ped.SpeakBubble:setBorderColor(Color.LightRed)
	ped.SpeakBubble:setTextColor(Color.LightRed)
	setElementData(ped, "clickable", true)
end
