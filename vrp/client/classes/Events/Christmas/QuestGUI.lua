...
function QuestGUI:constructor(Id, Name, Description, Packages)
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"EVo Christmas quests", true, true, self)
	self.m_Window:deleteOnClose(true)

	self.m_NameLabel = GUIGridLabel:new(1, 7, 24, 1, _("Today's quest: %d. December - %s", Id, Name), self.m_Window)
	self.m_Description = GUIGridLabel:new(1, 8, 24, 1, _("Description: %s", Description), self.m_Window)
	self.m_Packages = GUIGridLabel:new(1, 9, 24, 1, _("Reward: %s Päckchen", Packages), self.m_Window)

	self.m_StartQuest = GUIGridButton:new(21, 8, 4, 1, "Start quest", self.m_Window)
