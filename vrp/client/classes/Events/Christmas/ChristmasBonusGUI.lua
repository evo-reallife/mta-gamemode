...
-- *
-- *  PROJECT:     vRoleplay
-- *  FILE:        client/classes/Events/Christmas/ChristmasBonusGUI.lua
-- *  PURPOSE:     Christmas Bonus GUI
-- *
-- ****************************************************************************

ChristmasBonusGUI = inherit(GUIForm)
inherit(Singleton, ChristmasBonusGUI)

function ChristmasBonusGUI:constructor()
	...
	GUIGridLabel:new(1, 1, 15, 1, "Welcome to the X-Mas Premium Shop!\nHere you can turn your packets and candy canes into valuable rewards!", self.m_Window)
...
function ChristmasBonusGUI:addBonus(index, data)
...
function ChristmasBonusGUI:Event_receiveBonusData(bonusData)
	for name, data in ipairs(bonusData) do
		self:addBonus(index, data)
	end
end

function ChristmasBonusGUI:destructor()
